...
<html lang="en">
  <head>
    ...
    <div><h1 style="color: white;">Registrate</h1></div>
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label" style="color: white;">Nombre</label>
                ...
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label" style="color: white;">Repetir Contraseña</label>
                    <input type="password" class="form-control" name="password2" id="password2">
                  </div>

                
                <input type="submit"  name="btningre" class="btn btn-light" value="Registrar">
